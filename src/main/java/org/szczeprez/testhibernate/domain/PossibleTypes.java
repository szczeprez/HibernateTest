...
public class PossibleTypes {
	...
	private BigDecimal someBigDecima; 
	...
	@Transient
	private int ignoreField; // pole zostanie zignorowane przy tworzeniu tabel w bazie danych.
	...
	public BigDecimal getSomeBigDecima() {
		return someBigDecima;
	}

	public void setSomeBigDecima(BigDecimal someBigDecima) {
		this.someBigDecima = someBigDecima;
	}
